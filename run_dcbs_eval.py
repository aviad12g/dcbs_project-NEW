...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate DCBS against other sampling methods")
    parser.add_argument("--config", type=str, default="configs/study_config.yaml", 
                        help="Path to config file")
    parser.add_argument("--model_name", type=str, 
                        help="Model name/path (overrides config)")
    parser.add_argument("--benchmark", type=str, 
                        help="Path to benchmark file (overrides config)")
    ...
    parser.add_argument("--limit", type=int, 
                        help="Limit evaluation to this many examples")
