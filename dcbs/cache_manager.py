...
class DCBSCacheManager:
    ...
    def get_batch_embeddings(self, token_ids: list, embedding_layer: torch.nn.Embedding, 
                           device: torch.device) -> Tuple[torch.Tensor, list]:
        """
    ...
    def cache_batch_embeddings(self, token_ids: list, uncached_indices: list, 
        ...
        if self.config.enable_metrics:
            ...
            for cache_stats in stats.values():
                if cache_stats["metrics"]:
                    ...
                    total_requests += cache_stats["metrics"].hits + cache_stats["metrics"].misses
