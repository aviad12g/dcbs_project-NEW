    ...
    for url in urls:
        try:
            ...
            if url.endswith('.zip'):
                ...
                # Handle direct JSON
                data = response.json()
                return [process_arc_item(item, f"manual_{i}") for i, item in enumerate(data)]
    ...
    try:
        ...
        if isinstance(choices, dict):
            if 'text' in choices and 'label' in choices:
                ...
                choice_labels = nested.get('label', ['A', 'B', 'C', 'D'][:len(options)])
            else:
...
def create_extended_sample():
    ...
    questions = [
        ("A student wants to know how much space a cube takes up. Which unit should the student use?", 
         ["square inches", "cubic inches", "inches", "ounces"], "B"),
        
        ("Which characteristic do all living organisms share?", 
         ["They reproduce", "They move", "They make sounds", "They eat meat"], "A"),
        
        ("What happens when a solid is heated?", 
         ["It becomes a gas", "It melts", "It freezes", "It evaporates"], "B"),
        
        ("Which of these is a renewable energy source?", 
         ["Coal", "Oil", "Solar", "Natural gas"], "C"),
        
        ("What is the main function of roots in plants?", 
         ["To make food", "To absorb water", "To produce flowers", "To release oxygen"], "B"),
        
        ("What is the primary source of energy for most ecosystems?", 
         ["The sun", "Water", "Soil", "Air"], "A"),
        
        ("Which of these is an example of a chemical change?", 
         ["Ice melting", "Wood burning", "Glass breaking", "Water boiling"], "B"),
        
        ("What force pulls objects toward Earth?", 
         ["Magnetism", "Gravity", "Friction", "Electricity"], "B"),
        
        ("Which layer of Earth is the thickest?", 
         ["Crust", "Mantle", "Outer core", "Inner core"], "B"),
        
        ("What do plants need to make their own food?", 
         ["Soil and water", "Sunlight and carbon dioxide", "Oxygen and nitrogen", "Heat and minerals"], "B"),
        
        ("Which gas do plants absorb from the air?", 
         ["Oxygen", "Carbon dioxide", "Nitrogen", "Hydrogen"], "B"),
        
        ("What happens to water when it freezes?", 
         ["It becomes a gas", "It becomes a solid", "It disappears", "It becomes warmer"], "B"),
        
        ("Which tool would best measure the temperature of water?", 
         ["Ruler", "Thermometer", "Scale", "Timer"], "B"),
        
        ("What type of energy does a battery store?", 
         ["Heat energy", "Chemical energy", "Light energy", "Sound energy"], "B"),
        
        ("Which of these animals is a mammal?", 
         ["Shark", "Whale", "Turtle", "Fish"], "B"),
        
        # Add more science questions
        ("What is the smallest unit of matter?", 
         ["Molecule", "Atom", "Cell", "Organism"], "B"),
        
        ("Which planet is closest to the Sun?", 
         ["Venus", "Mercury", "Earth", "Mars"], "B"),
        
        ("What is the process by which plants make food?", 
         ["Respiration", "Photosynthesis", "Digestion", "Circulation"], "B"),
        
        ("Which state of matter has a definite shape and volume?", 
         ["Gas", "Liquid", "Solid", "Plasma"], "C"),
        
        ("What is the center of an atom called?", 
         ["Electron", "Proton", "Neutron", "Nucleus"], "D"),
        
        ("Which type of rock is formed by cooling magma?", 
         ["Sedimentary", "Metamorphic", "Igneous", "Fossil"], "C"),
        
        ("What is the main gas in Earth's atmosphere?", 
         ["Oxygen", "Carbon dioxide", "Nitrogen", "Hydrogen"], "C"),
        
        ("Which organ pumps blood through the body?", 
         ["Lungs", "Brain", "Heart", "Liver"], "C"),
        
        ("What is the hardest natural substance?", 
         ["Gold", "Iron", "Diamond", "Quartz"], "C"),
        
        ("Which force opposes motion?", 
         ["Gravity", "Friction", "Magnetism", "Electricity"], "B"),
        ...
        ("Which part of the plant conducts photosynthesis?", 
         ["Roots", "Stem", "Leaves", "Flowers"], "C"),
        
        ("What is the speed of light?", 
         ["300,000 km/s", "150,000 km/s", "450,000 km/s", "600,000 km/s"], "A"),
        
        ("Which blood type is the universal donor?", 
         ["A", "B", "AB", "O"], "D"),
        
        ("What is the largest organ in the human body?", 
         ["Heart", "Brain", "Liver", "Skin"], "D"),
        
        ("Which gas makes up about 21% of Earth's atmosphere?", 
         ["Nitrogen", "Oxygen", "Carbon dioxide", "Argon"], "B"),
        ...
        ("What is the basic unit of life?", 
         ["Tissue", "Organ", "Cell", "System"], "C"),
        
        ("Which type of energy is stored in food?", 
         ["Kinetic", "Potential", "Chemical", "Thermal"], "C"),
        
        ("What is the pH of pure water?", 
         ["6", "7", "8", "9"], "B"),
        
        ("Which part of the eye controls the amount of light entering?", 
         ["Cornea", "Lens", "Iris", "Retina"], "C"),
        
        ("What is the most abundant element in the universe?", 
         ["Oxygen", "Carbon", "Hydrogen", "Helium"], "C"),
        
        ("Which type of wave is sound?", 
         ["Electromagnetic", "Longitudinal", "Transverse", "Standing"], "B"),
        
        ("What is the powerhouse of the cell?", 
         ["Nucleus", "Ribosome", "Mitochondria", "Chloroplast"], "C"),
        
        ("Which law states that energy cannot be created or destroyed?", 
         ["Newton's First Law", "Law of Conservation of Energy", "Ohm's Law", "Boyle's Law"], "B"),
        
        ("What is the study of earthquakes called?", 
         ["Geology", "Seismology", "Meteorology", "Astronomy"], "B"),
        
        ("Which vitamin is produced when skin is exposed to sunlight?", 
         ["Vitamin A", "Vitamin B", "Vitamin C", "Vitamin D"], "D"),
        
        ("What is the chemical formula for table salt?", 
         ["NaCl", "KCl", "CaCl2", "MgCl2"], "A"),
        
        ("Which part of the brain controls balance?", 
         ["Cerebrum", "Cerebellum", "Brainstem", "Hypothalamus"], "B"),
        
        ("What is the smallest bone in the human body?", 
         ["Stapes", "Malleus", "Incus", "Radius"], "A"),
        
        ("Which gas is released during photosynthesis?", 
         ["Carbon dioxide", "Oxygen", "Nitrogen", "Hydrogen"], "B"),
        
        ("What is the unit of electrical resistance?", 
         ["Volt", "Ampere", "Ohm", "Watt"], "C"),
        
        ("Which type of rock is limestone?", 
         ["Igneous", "Metamorphic", "Sedimentary", "Volcanic"], "C"),
        
        ("What is the normal human body temperature in Celsius?", 
         ["35°C", "37°C", "39°C", "41°C"], "B"),
    ]
...
def main():
    ...
    parser.add_argument("--output", type=str, default="data/arc_easy_full.json",
