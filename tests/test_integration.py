...
from visualization import generate_all_visualizations, AccuracyVisualizer
...
class TestChatTemplateManager:
    ...
    def test_template_selection(self):
        ...
        assert "llama" in mock_tokenizer.chat_template.lower() or "start_header_id" in mock_tokenizer.chat_template
...
class TestExampleProcessor:
    ...
    def test_create_prompt(self):
        ...
        # Test without CoT
        prompt_no_cot = self.processor.create_prompt(sentence, options, include_cot=False)
...
class TestVisualization:
    ...
    def test_visualization_data_extraction(self):
        ...
        methods, accuracies, intervals, sample_sizes = visualizer._extract_data(self.test_results)
...
class TestEndToEndIntegration:
    ...
    def test_complete_pipeline_mock(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('evaluation_core.ModelManager.load_model') as mock_load, \
                 patch('evaluation_core.ExampleProcessor.process_example') as mock_process, \
                 patch('evaluation_core.ExampleProcessor.get_answer_token_ids') as mock_get_ids, \
                 patch('matplotlib.pyplot.savefig'), \
                 patch('matplotlib.pyplot.close'):
