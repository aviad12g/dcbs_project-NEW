...
class LlamaTemplate(ChatTemplate):
    ...
    def _apply_llama2(self, messages: List[Dict[str, str]], add_generation_prompt: bool) -> str:
    ...
    def _apply_llama3(self, messages: List[Dict[str, str]], add_generation_prompt: bool) -> str:
...
class ChatTemplateManager:
    ...
    def apply_template(self, model_name: str, messages: List[Dict[str, str]], 
    ...
    def validate_template_compatibility(self, model_name: str, 
                                      test_messages: Optional[List[Dict[str, str]]] = None) -> bool:
