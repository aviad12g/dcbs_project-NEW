...
from evaluation_core import EvaluationRunner, EvaluationConfig
...
class CrossValidator:
    ...
    def cross_validate(self, eval_config: EvaluationConfig, 
                      benchmark_data: List[Dict]) -> Dict:
...
def run_cross_validation(eval_config: EvaluationConfig, 
                        benchmark_data: List[Dict],
                        cv_config: Optional[CrossValidationConfig] = None) -> Dict:
    """
